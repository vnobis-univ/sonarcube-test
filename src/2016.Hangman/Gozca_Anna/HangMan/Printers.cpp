...
Printer blueTextWhiteBG(Color::RED, Color::LIGHT_WHITE);
Printer blueTextGrayBG(Color::RED, Color::LIGHT_YELLOW);

void typeName()
{
	string gameLine = "HANGMAN";
	printAtCenter(0, gameLine, blueTextGrayBG);
}
