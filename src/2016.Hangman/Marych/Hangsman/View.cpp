...
Printer View::defaultPrinter = Printer(Color::LIGHT_BLUE, Color::BLACK);
Printer View::defaultPrinterBg = Printer(Color::BLACK, Color::LIGHT_BLUE);
...
void View::drawBackground()
{
	...
	printAtCenterOfLine(0, "-->  HANGSMAN  <--", defaultPrinterBg);
